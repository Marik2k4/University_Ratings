...
export default function AboutItem(props) {
  return (
    <div className='AboutItem'>
        ...
        <div className='logo' >
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="40.026 40.026 319.948 319.948" viewBox="40.026 40.026 319.948 319.948" height="45" width="45" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true">
                <g>
        ...
        <Link className='AboutBut' to={`${props.link}`}>
            Развернуть
        </Link>
